...
const library = {
  ...
  'Collapse filter list': { de: 'Filteroptionen ausblenden', cs: 'Skrýt možnosti filtru' },
  ...
  'Reset filter': { de: 'Filter zurücksetzen', cs: 'Resetovat filtr' },
  ...
  'Show filter list': { de: 'Filteroptionen anzeigen', cs: 'Zobrazit možnosti filtru'},
