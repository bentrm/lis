# Generated by Django 2.0.2 on 2018-07-06 11:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title_de', models.CharField(blank=True, help_text='The german title of the tag as shown to the user.', max_length=1000, unique=True, verbose_name='German title')),
                ('title_cs', models.CharField(blank=True, help_text='The czech title of the tag as show to the user.', max_length=1000, unique=True, verbose_name='Czech title')),
                ...
                ('sort_order', models.IntegerField(help_text='Defines the relative order of the tag in the UI.', verbose_name='Sort order')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'db_table': 'cms_tag_literary_period',
            },
        ),
        ...
        migrations.AddField(
            model_name='authorpage',
            name='genre_tags',
            field=modelcluster.fields.ParentalManyToManyField(blank=True, db_table='cms_author_tag_genre', related_name='authors', to='cms.GenreTag'),
        ),
        migrations.AddField(
            model_name='authorpage',
            name='language_tags',
            field=modelcluster.fields.ParentalManyToManyField(blank=True, db_table='cms_author_tag_language', related_name='authors', to='cms.LanguageTag'),
        ),
    ]
