...
TXT = {
    ...
    "author.literary_category.help": _("The literary categories the author is associated with."),
    ...
    "author.name": _("Name"),
    "author.place_of_birth_cs.help": _("Place of birth if different in Czech spelling."),
    "author.place_of_birth_de.help": _("Place of birth if different in German spelling."),
    "author.place_of_birth.help": _("The city or village where the author was born."),
    "author.place_of_birth": _("Place of birth"),
    "author.place_of_death_cs.help": _("Place of death if different in Czech spelling."),
    "author.place_of_death_de.help": _("Place of death if different in German spelling."),
    ...
    "document_media.summary.help": _("A short and concise summary of the content of the document."),
    ...
    "location.contact_info.help": _("An address, a weblink or phone contact that may be helpful to visit this place."),
    ...
    "location.location_type_tags.help": _("The location types that describe this location best."),
    ...
    "memorial_site.contact_info.help": _("An address, a weblink or phone contact that may be helpful to visit this place."),
    ...
    "memorial_site.directions.help": _("A short description of directions to find the location."),
    ...
    "memorial_site.location_type_tags.help": _("The location types that describe this location best."),
    "memorial_site.location_type_tags.plural": _("Location types"),
    "memorial_site.memorial_type_tags.help": _("The location types that describe this location best."),
    "memorial_site.memorial_type_tags.plural": _("Location types"),
    "memorial_site.plural": _("Locations"),
    "memorial_site.plural": _("Memorial sites"),
    "memorial_site.title_image.help": _("A meaningful image that will be used to present the location to the user."),
    ...
    "page.temporary_redirect.help": _("A target url or slug that this page will redirect to."),
